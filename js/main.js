...
let boton = document.getElementById("botonBlack");

function cambiarModoOscuro() { 
    estilo.setAttribute("href", "css/blackstyle.css")
}

function cambiarModoClaro() { 
    estilo.setAttribute("href", "css/whitestyle.css")
}
...
function reset(){ 
    ...
    document.getElementById('porcentajeNums').value = "0%";
    document.getElementById('porcentajeLetras').value = "0%";
    document.getElementById('porcentajeEspeciales').value = "0%";
}
...
function armarEstructuraCadena(){
    var caracterTotal = document.getElementById("cantTotalCaracteres");
    var cadena = document.getElementById("inputPassword").value;
    ...
    caracterTotal.innerHTML = secuencia.length;
    return secuencia;
